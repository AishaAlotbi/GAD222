...
public class ChoicePanel : MonoBehaviour
{
    ...
    private const float BUTTON_HEIGHT_PER_LINE = 100;
    private const float BUTTON_HEIGHT_PADDING = 200;
    ...
    {
        float maxWidth = 0; //width of the biggest button, use to keep buttons uniform
        ...
        foreach(var button in buttons)
        {
            ...
            button.layout.preferredWidth = BUTTON_HEIGHT_PADDING + (BUTTON_HEIGHT_PER_LINE * lines);
        }
    }
